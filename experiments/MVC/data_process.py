...
def saveResult(save_path, npyfile, times=1, drawCircle_path='observation/', metrics_path='observation/metrics.txt'):
    ...
    drawCircle_save(path_save=drawCircle_path, d=12)
