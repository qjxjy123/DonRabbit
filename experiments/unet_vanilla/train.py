...
myGeneTrain = trainGenerator(4, train_path, 'image', 'label',
                             train_data_gen_args,target_size=(HEIGHT, WIDTH), crop_pattern='4_size', mask_color_mode='rgba')  # ,save_to_dir = r'data/cell/train/aug/'
myGeneValid = trainGenerator(4, valid_path, 'image', 'label', valid_data_gen_args,target_size=(HEIGHT, WIDTH), crop_pattern='4_size', mask_color_mode='rgba')

model = unet(loss=LOSS_INFO,nb_classes=const.NB_CLASSES)
